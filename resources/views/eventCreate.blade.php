    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('saveEvent') }}" id="eventForm">
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputEmail1">Name</label>
                            <input autocomplete="off" type="text" class="form-control" id="name" name="name" aria-describedby="emailHelp" placeholder="Enter event name">
                        </div>
                        <div class="form-group row">
                            <div class="col">
                                <label for="startAt">Start At</label>
                                <input type="text" class="form-control" id="from" name="startAt">
                            </div>
                            <div class="col">
                                <label for="endAt">End At</label>
                                <input type="text" class="form-control" id="to" name="endAt">
                            </div>
                        </div>
